...
public class ResourceNotFoundException extends RuntimeException {
    ...
    public ResourceNotFoundException(String code, String message, boolean isBackend) {
        super( message );
        this.code = code;
        this.args = null;
    }

    public ResourceNotFoundException(String code, String message, Throwable e, Object... args) {
        super( message, e );
        this.code = code;
        this.args = args;
    }
